...
$showData = "SELECT id, uuid, date, keytype, devicekey, keystatus, datecount FROM tbldebkey WHERE email = '$email' ORDER BY id ASC";
                                    ...
                                    <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                        <thead>
                                            <tr class="bg-transparent">
                                                ...
                                                <th class="text-center" style="width: 9px">Date</th>
                                                <th class="text-center" style="width: 9px">Del</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
