...
<head>
    ...
    <title>Add Post | APIServer Dashboard</title>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mt-4 mt-lg-0">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="checkbox" id="switch2" switch="success" checked />
                                                    <label for="switch2" data-on-label="ON" data-off-label="OFF"></label>
                                                    <input type="text" class="form-control" id="post_daytotal">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="username" class="col-sm-9 col-form-label">Giá tuần (Khi tắt đi sẽ ngầm định là không hỗ trợ bán theo tuần)</label>
                                                <div class="col-sm-9">
                                                    <input type="checkbox" id="switch3" switch="success" checked />
                                                    <label for="switch3" data-on-label="ON" data-off-label="OFF"></label>
                                                    <input type="text" class="form-control" id="post_weektotal">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control" id="post_monthtotal">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" id="packageid">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $arrS['id'] ?>"><?php echo 'ID: ' . $arrS['id'] . ' - ' . $arrS['debname'] ?></option>
                                                        <?php
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="postimg">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="postdeblink">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <button id="submit" type="button" class="btn btn-primary w-md"><i class="bx bx-save"></i> Post</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
