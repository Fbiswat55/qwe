<?php
$username = "trieubao_admin"; // Khai báo username
$password = "quocbao123@";      // Khai báo password
$server   = "localhost";   // Khai báo server
$dbname   = "trieubao_db";      // Khai báo database
...
if (mysqli_num_rows($result) > 0) {
    $sqlupdate = "Update tbldebkey set status='4', date='$date', title='$title',uuid='$uuid' where uuid='$uuid'";
    ...
    $sql = "INSERT INTO tbldebkey (title, date, uuid, status, message) VALUES ('$title', '$date', '$uuid', '4', '$message')";
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <a>Nhập tên, set thời hạn và dán uuid vào để kích hoạt</a>
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Name (Sẽ hiển thị trên deb dạng username)"  name="title" required>
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Message (Sẽ hiển thị trên deb dạng text khi vào deb)" name="message" required>
                        </div>
                        <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder="Set Date" name="date" required>
                                </div>
                <div class="input-group">
