...
$showData = "SELECT id, debstatus,debname, debversion, newdeblink, debupdatenoti, debcontact, debhash, hashcheck FROM tbldebver where email = '$email' ORDER BY id ASC";
                                    ...
                                    <table class="table dtr-inline datatable dt-responsive" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                                        <thead>
                                            <tr class="bg-transparent">
                                                ...
                                                <th data-priority="1" class="text-center" style="width: 9px">Check hash</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($arrS['hashcheck'] == 1) {
                                                            echo "<button onclick='checkoff(" . $arrS['id'] . ")' class='btn btn-soft-success btn-sm w-xs waves-effect btn-label waves-light'><i class='fas fa-toggle-on label-icon'></i>ON</button>";
                                                        } else {
                                                            echo "<button onclick='checkon(" . $arrS['id'] . ")' class='btn btn-soft-danger btn-sm w-xs waves-effect btn-label waves-light'><i class='fas fa-toggle-off label-icon'></i>OFF</button>";
                                                        }
                                                        ?>
...
<script>
    ...
    function checkoff(id) {
        Swal.fire({
            title: 'Xác nhận',
            icon: 'warning',
            text: `Xác nhận tắt kiểm tra mã sha1, gói của bạn có thể bị crack ?`,
            showCancelButton: true,
            confirmButtonText: "Xác nhận",
    ...
    function checkon(id) {
        Swal.fire({
            title: 'Xác nhận',
            icon: 'warning',
            text: `Xác nhận bật kiểm tra mã sha1, hãy cập nhật lại mã sha1 sau khi bật lại tính năng này ?`,
            showCancelButton: true,
            confirmButtonText: "Xác nhận",
