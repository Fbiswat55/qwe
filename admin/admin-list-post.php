...
inner join tbldebver on tbldebver.id = tblproduct.debid
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="checkbox" onclick="totaltypechange(<?= $arrS['id'] ?>)" id="switch3" switch="dark" <?php if ($arrS['totaltype'] == 1) echo 'checked' ?> />
                                                        <label for="switch3" data-on-label="Bán" data-off-label="Free"></label>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="checkbox" onclick="allowget(<?= $arrS['id'] ?>)" id="switch1" switch="none" <?php if ($arrS['allowgetkey'] == true) echo 'checked' ?> />
                                                        <label for="switch1" data-on-label="ON" data-off-label="OFF"></label>
                                                    </td>
                                                    <td class="text-center">
                                                        <input type="checkbox" onclick="status(<?= $arrS['id'] ?>)" id="switch2" switch="none" <?php if ($arrS['status'] == false) echo 'checked' ?> />
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo "<button onclick='datepick(" . $arrS['id'] . ")' class='btn btn-soft-light btn-sm w-xs waves-effect btn-label waves-light'><i class='bx bx-calendar-plus label-icon'></i> History</button>";
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
...
<script>
    ...
    function status(id) {
        var check2 = document.querySelector("#switch2").checked;
        if (check2) {
            $.ajax({
                url: baseurl + '/admin/module/ajax-post.php',
                type: 'POST',
    ...
    function totaltypechange(id) {
        var check = document.querySelector("#switch3").checked;
        if (check) {
            $.ajax({
                url: baseurl + '/admin/module/ajax-post.php',
                type: 'POST',
    ...
    function allowget(id) {
        var check = document.querySelector("#switch1").checked;
        if (check) {
            $.ajax({
                url: baseurl + '/admin/module/ajax-post.php',
                type: 'POST',
